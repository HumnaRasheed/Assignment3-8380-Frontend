  ...
  <main>
    ...
    <v-container fluid ma-0 pa-0 fill-height>
      <v-layout column align-center>
        <blockquote>
          <strong>&#8220;Welcome {{validUserName}}!&#8221;</strong>
          <footer>
            <small>
              ...
              <v-layout row>
                <v-flex xs4>
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-btn flat color="orange" @click="viewCustomers">Customers</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-flex>
                ...
                <v-flex xs4>
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-btn flat color="orange" @click="viewInvestments">Investments</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-flex>
                <v-flex xs4>
                  <v-card>
                    ...
                    <v-card-actions>
                      <v-btn flat color="orange" @click="viewStocks">Stocks</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-flex>
              </v-layout>
